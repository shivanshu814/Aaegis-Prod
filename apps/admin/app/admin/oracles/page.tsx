...
export default function OraclesPage() {
  ...
  const handleUpdateTtl = async () => {
    ...
    try {
      ...
      alert("Oracle TTL updated successfully");
      fetchData();
    } catch (e) {
      console.error(e);
      alert("Error updating Oracle TTL");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUpdateAuthority = async () => {
    ...
    try {
      ...
      alert("Oracle Authority updated successfully");
      fetchData();
    } catch (e) {
      console.error(e);
      alert("Error updating Oracle Authority");
    } finally {
      setLoading(false);
    }
  };
