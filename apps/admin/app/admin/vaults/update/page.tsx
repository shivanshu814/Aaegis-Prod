...
function UpdateVaultContent() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toast.success("Vault Type Updated Successfully!", { id: toastId });
      router.push("/admin/vaults");
    } catch (e) {
      console.error(e);
      toast.error("Error updating vault type", { id: toastId });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="glass border border-white/10 rounded-2xl p-8 shadow-xl">
        ...
        <div className="flex gap-4 mt-8">
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-xl font-semibold btn-gradient disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-purple-500/20"
          >
